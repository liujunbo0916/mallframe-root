...
public class EAImage {
    ...
    *//**
    ...
    public static void main(String[] args) throws Exception {
      ...
      /*      targetPath = EAImage.cutImage(file.getPath(), targetPath, x , y , width, height);
            
            String bigTargetPath = pathPrefix  + System.currentTimeMillis() + pathSuffix;
            EAImage.zoom(targetPath, bigTargetPath, 100, 100);
            
            String smallTargetPath = pathPrefix  + System.currentTimeMillis() + pathSuffix;
            EAImage.zoom(targetPath, smallTargetPath, 50, 50);*/
            
            /************************ 基于JDK Image I/O 解决方案(JDK探索失败) *************************/
            File destFile = new File(targetPath);
            EAImage.cutImage(file, destFile, x, y, width, height);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
