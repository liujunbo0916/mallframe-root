...
public class Jurisdiction {
	...
	public static String getUsername(){
		return ((Admin)getSession().getAttribute(Const.SESSION_USER)).getUSERNAME();
	}
	
	/**获取当前按钮权限(增删改查)
	 * {chas=1, email=1, edits=1, dels=1, adds=1, FromExcel=1, toExcel=1, sms=1, FHSMS=1}
	 * @return
	 */
	@SuppressWarnings("unchecked")
